function janken () {
    /* 変数定義 ************************/
    // ジャンケンの手の番号を設定
    // var GU    = document.getElementById('gu').innerHTML;
    // var CHOKI = document.getElementById('chi').innerHTML;
    // var PA    = document.getElementById('pa').innerHTML;
    var GU    = document.getElementById('gu').textContent;
    var CHOKI = document.getElementById('chi').textContent;
    var PA    = document.getElementById('pa').textContent;
    // var GU    = 1
    // var CHOKI = 2
    // var PA    = 3
    // console.log(GU)
